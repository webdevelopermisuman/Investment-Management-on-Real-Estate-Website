...
/* misc */
.dtr-box-sm { margin: 5px 0; }
}
@media (max-width: 767px) {
.small-device-space { margin: 25px 0 !important; }
.small-device-center { text-align: center; }
.footer-col-2 { margin-top: 30px; text-align: left; }
.dtr-footer-main .dtr-list-inline, .dtr-footer-main .dtr-social-list { margin-left: -10px; }
/* forms */
...
.dtr-box-wrapper-round { border-radius: 0; }
.dtr-box-full-img { min-height: 300px; }
.dtr-rounded-left-bottom { border-radius: 0; }
}
